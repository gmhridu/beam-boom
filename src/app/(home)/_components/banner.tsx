  ...
  return (
    ...
    >
      ...
      <div className="relative h-full">
        ...
        {/* Social Media */}
        <div className="absolute left-[70px] bottom-[50px] z-10 hidden md:block">
          <ul className="flex items-center p-0 m-0">
            <li className="list-none text-[20px] leading-[20px] text-black px-[20px] border-r border-dashed border-[#4995D1] first:pl-0">
              <a
            ...
            <li className="list-none text-[20px] leading-[20px] text-black px-[20px] border-r border-dashed border-[#4995D1]">
              <a
              ...
              >
                ...
                <span className="ml-[10px]">Twitter</span>
              </a>
            </li>
            <li className="list-none text-[20px] leading-[20px] text-black px-[20px] border-r border-dashed border-[#4995D1]">
              <a
              ...
              >
                ...
                <span className="ml-[10px]">Instagram</span>
              </a>
            </li>
          </ul>
        </div>
