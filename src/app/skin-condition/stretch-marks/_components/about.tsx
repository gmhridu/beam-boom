        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="pulse-light-description text-base md:text-lg  max-w-2xl mb-10 space-y-4">
              <p>
                Stretch marks are a type of scar that form when the skin
                stretches or shrinks quickly. This rapid change causes the
                collagen and elastin, which support the skin, to break down. As
                the skin heals, stretch marks can appear.
              </p>

              <p>
                However, not everyone gets stretch marks. Fluctuating hormone
                levels seem to contribute to their development, and you may be
                more prone to them if your family members have stretch marks.
              </p>
            </div>
            <ViewTransitionLink
