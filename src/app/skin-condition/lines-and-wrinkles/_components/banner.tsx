...
const slides: Slide[] = [
  {
    ...
    description: "Advanced laser treatments for a smoother, more youthful complexion. Restore your skin's natural radiance with our non-surgical rejuvenation solutions.",
    backgroundImage:
