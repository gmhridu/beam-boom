...
const slides: Slide[] = [
  {
    ...
    description: "Restore your skin's natural radiance with our advanced non-surgical treatments. Targeted solutions for sun spots, melasma, and uneven tone for a clearer, more balanced complexion.",
    backgroundImage:
    ...
    foregroundImage:
      "https://res.cloudinary.com/dyq0ij1yk/image/upload/f_auto,q_auto:eco,w_auto,dpr_auto,c_limit/v1774168288/e0w8zsr7o11krsbkyvic.avif",
