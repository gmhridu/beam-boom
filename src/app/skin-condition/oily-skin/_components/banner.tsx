...
const slides: Slide[] = [
  {
    ...
    title: "OILY SKIN",
    description: "Balance and clarify your skin with our advanced non-surgical treatments. Targeted solutions for excess sebum, enlarged pores, and congestion for a clearer, healthier complexion.",
    backgroundImage:
    ...
    foregroundImage:
      "https://res.cloudinary.com/dyq0ij1yk/image/upload/f_auto,q_auto:eco,w_auto,dpr_auto,c_limit/v1774167977/kyfivp5igxasc3viufqx.avif",
