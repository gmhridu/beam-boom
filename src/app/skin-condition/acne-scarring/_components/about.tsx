        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-8 lg:mb-12">
          ...
          <div className="space-y-4 md:space-y-6 order-2 lg:order-1">
            ...
            <div className="bb-light-description text-sm sm:text-base md:text-lg max-w-2xl space-y-3 md:space-y-4">
              <p className="bb-light-description text-gray-600 leading-relaxed text-lg"> Acne scarring can remain long after breakouts have cleared, often leaving uneven skin texture, visible marks and areas of indentation that affect the overall appearance of the skin. These scars commonly appear on the cheeks, temples and jawline, and can vary in depth and severity. </p> <p className="bb-light-description text-gray-600 leading-relaxed text-lg"> At Beam & Bloom, we offer advanced laser treatments designed to visibly improve the appearance of acne scars and restore smoother, healthier-looking skin. By stimulating collagen production deep within the skin, these treatments encourage natural skin regeneration, helping to refine texture and improve overall skin tone. </p>
            </div>
            <div className="pt-2">
              <ViewTransitionLink
