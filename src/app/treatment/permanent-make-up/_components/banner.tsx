...
const slides: Slide[] = [
  {
    ...
    description:
      "Achieve long-lasting, natural beauty with professional permanent make-up treatments designed to enhance your features effortlessly.",
    backgroundImage:
    ...
    foregroundImage:
      "https://res.cloudinary.com/dyq0ij1yk/image/upload/f_auto,q_auto:eco,w_auto,dpr_auto,c_limit/v1773074012/kt07fqypbhg11obwytx1.avif",
