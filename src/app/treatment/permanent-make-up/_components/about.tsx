      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-8 lg:mb-12">
          ...
          <div className="space-y-4 md:space-y-6 order-2 lg:order-1">
            ...
            <div className="bb-light-description text-sm sm:text-base md:text-lg max-w-2xl mb-6 md:mb-10 space-y-3 md:space-y-4 dark:text-gray-300 transition-colors duration-300">
              <p>
                Permanent make-up is an advanced cosmetic treatment designed to enhance your natural features while saving time in your daily beauty routine. At <span className='font-medium text-black dark:text-white'>Beam & Bloom in Dartford</span>, we offer professional permanent make-up treatments that help define and shape areas such as the eyebrows, eyeliner, and lips for a long-lasting, natural-looking finish.
              </p>
              <p>
