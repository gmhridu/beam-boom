              ...
              <div className="our-price-item flex-1 w-full flex flex-col items-center">
                ...
                {card.subtitle && (
                  <div className="mb-4 sm:mb-6 w-full flex justify-center">
                    <span className="detail inline-block border-b-2 border-blue-400 pb-1 uppercase tracking-wider text-xs sm:text-sm dark:text-white transition-colors duration-300">
                      {card.subtitle}
                    </span>
                  </div>
                )}
