...
const slides: Slide[] = [
  {
    ...
    foregroundImage:
      "https://www.pulse-clinic.co.uk/wp-content/uploads/2023/05/banner-right-img-5.jpg",
...
export default function Banner() {
  ...
  return (
    <section
      ...
      className="relative banner-wrp h-160 md:h-190 lg:h-220 overflow-hidden bg-gray-50 dark:bg-gray-950 transition-colors duration-300"
    >
      {/* Slides */}
