...
const slides: Slide[] = [
  {
    ...
    description: "At Beam & Bloom, we offer a range of premium non-surgical treatments to help you achieve your desired results. Our prices are transparent and competitive, ensuring exceptional value for expert care.",
    backgroundImage:
